...
import {Button, Flex, Icon, Td, Tr, useDisclosure, useToast, Wrap, WrapItem} from "@chakra-ui/react";
...
const TagIndex = () => {
    ...
    const closeAlertModal = (next: any) => {
        if (next === true && selectedTag.current) {
            apiDeleteTag(selectedTag.current).then((res) => {
                toast({
                    title: "Tag deleted",
                                    ...
                                    <Wrap>
                                        <WrapItem>
                                            ...
                                            <Button
                                                ...
                                                variant={"ghost"}
                                                size={"sm"}
                                                onClick={() => openModal(tag.id as string)}
                                            >
                                                <FaRegPaperPlane/>
                                            </Button>
                                        </WrapItem>
