                ...
                <Stack
                    ...
                    <Stack spacing={4}>
                        ...
                        <Text color={'gray.500'} fontSize={{base: 'sm', sm: 'md'}}>
                            Welcome! Please enter your email and password to access your account.
                        </Text>
                    </Stack>
                    <Box as={'form'} mt={10} onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <Button
                            ...
                            mt={8}
                            w={'full'}
                            bgGradient={loginLoading ? 'linear(to-r, blue.400,blue.400)' : 'linear(to-r, blue.400,blue.800)'}
                            color={'white'}
                            _hover={{
